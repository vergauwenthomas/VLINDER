...
_Imagedir = "/home/thoverga/Documents/VLINDER_github/VLINDER/hittestress_workshop/rayman_scripts/fisheye_fotos"
Image_file = 'Vlinder_36_Koekelberg.jpg'

#debug
image_path = os.path.join(_Imagedir, Image_file)

output_path = os.path.join(_Imagedir, Image_file[:-4] + '_converted.bmp')
